...
/**
 * This is the extension manager of the Cecintegration extension.
 */
public class CecintegrationManager extends GeneratedCecintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CecintegrationManager.class.getName());
	 ...
	 */
	public static CecintegrationManager getInstance()
	{
		return (CecintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CecintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CecintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CecintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CecintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CecintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
